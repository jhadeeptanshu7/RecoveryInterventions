...
def load_input_folder():
    input_folder = '/Users/jhadeeptanshu/plos_one_classifications/activity/batch_input_folder'
    return input_folder
...
def get_user_subreddit_activity(input_folder):
    ...
    for text_file in os.listdir(input_folder):
        ...
        if text_file.endswith(".txt"):
            text_file_path = sub_folder_path = os.path.join(input_folder,text_file)
